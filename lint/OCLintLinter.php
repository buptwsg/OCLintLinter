...
final class OCLintLinter extends ArcanistCommandLinter {
    ...
    protected function prepareToLint() {
        ...
        print_r($configuration->buildCommand($build_flags));
        if ($result[0]) {
